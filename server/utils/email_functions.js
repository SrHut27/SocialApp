    ...
    const mailOptions = {
        ...
        html: `
            <div style="font-family: Arial, sans-serif; font-size: 16px; color: #333;">
                ...
                <a href="http://localhost:3001/auth/reset-password/${resetToken}" style="display: inline-block; padding: 10px 20px; background-color: #00642c; color: #fff; text-decoration: none; border-radius: 5px;">Redefinir Senha</a>
